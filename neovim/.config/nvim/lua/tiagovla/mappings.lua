...
local function better_hlsearch()
    local current_word = vim.call("expand", "<cword>")
    vim.fn.setreg("/", "\\<" .. current_word .. "\\>")
    vim.api.nvim_command "set hlsearch"
end

local function better_close()
...
vim.keymap.set("n", "<leader>q", better_close, { desc = "Close buffer" })
...
vim.keymap.set({ "n", "x", "o" }, "n", '"Nn"[v:searchforward]', { expr = true, desc = "Better forward N behaviour" })
vim.keymap.set({ "n", "x", "o" }, "N", '"nN"[v:searchforward]', { expr = true, desc = "Better backward N behaviour" })
